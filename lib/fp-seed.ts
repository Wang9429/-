...
import { FP_HISTORY_STATEMENTS } from "./fp-history-seed";
...
export const FP_STATEMENTS: FinancialStatement[] = [
  ...
  },
  {
    ...
    amount_unit: "万元",
    revenue: 39000,
    operating_profit: 3120,
    total_assets: 182000,
    total_liabilities: 100500,
    equity: 81500,
    current_assets: 53000,
    current_liabilities: 35500,
    operating_cf: 2200,
    interest_bearing_debt: 27800,
    cash_on_bs: 6700,
    net_profit: 2340,
    equity_begin: 81000,
    data_nature: "synthetic_statement",
  },
  {
    ...
    amount_unit: "万元",
    revenue: 29000,
    operating_profit: 1740,
    total_assets: 60000,
    total_liabilities: 33500,
    equity: 26500,
    current_assets: 17500,
    current_liabilities: 11800,
    operating_cf: 1280,
    interest_bearing_debt: 11000,
    cash_on_bs: 4620,
    net_profit: 1305,
    equity_begin: 25200,
    data_nature: "synthetic_statement",
  },
  {
    ...
    total_assets: 62000,
    total_liabilities: 34500,
    equity: 27500,
    current_assets: 18200,
    current_liabilities: 12100,
    operating_cf: 1340,
    interest_bearing_debt: 11500,
    cash_on_bs: 4800,
    net_profit: 1350,
    equity_begin: 26500,
    data_nature: "synthetic_statement",
  },
  {
    ...
    operating_profit: 1860,
    total_assets: 39500,
    total_liabilities: 16700,
    equity: 22800,
    current_assets: 13100,
    current_liabilities: 8400,
    operating_cf: 1480,
    interest_bearing_debt: 7200,
    cash_on_bs: 1320,
    net_profit: 1395,
    equity_begin: 21600,
    data_nature: "synthetic_statement",
  },
  {
    ...
    amount_unit: "万元",
    revenue: 21200,
    operating_profit: 1900,
    total_assets: 40800,
    total_liabilities: 18000,
    equity: 22800,
    current_assets: 13600,
    current_liabilities: 8700,
    operating_cf: 1520,
    interest_bearing_debt: 7600,
    cash_on_bs: 1400,
    net_profit: 1425,
    equity_begin: 22800,
    data_nature: "synthetic_statement",
  },
  {
    ...
    total_assets: 19800,
    total_liabilities: 8400,
    equity: 11400,
    current_assets: 6500,
    current_liabilities: 3700,
    operating_cf: 540,
    interest_bearing_debt: 2300,
    cash_on_bs: 360,
    net_profit: 615,
    equity_begin: 10800,
    data_nature: "synthetic_statement",
  },
  {
    ...
    total_assets: 20400,
    total_liabilities: 8700,
    equity: 11700,
    current_assets: 6700,
    current_liabilities: 3850,
    operating_cf: 560,
    interest_bearing_debt: 2400,
    cash_on_bs: 380,
    net_profit: 638,
    equity_begin: 11400,
    data_nature: "synthetic_statement",
  },
  ...(FP_HISTORY_STATEMENTS as FinancialStatement[]),
];
...
export const FP_GUARANTEES: GuaranteeFacility[] = [
  {
    ...
    kind: "loan_guarantee",
    amount_wan: 3000,
    approved_limit_wan: 2000,
    occupancy_basis: "同一被担保对象有效占用，按责任金额",
  ...
  {
    id: "GUAR-OK",
    name: "为单位C所属企业提供担保（额度内）",
    owner_org_id: "ORG-C",
    guarantor_id: "LE-C",
    beneficiary_id: "LE-PART",
    kind: "loan_guarantee",
    amount_wan: 800,
    approved_limit_wan: 2000,
    occupancy_basis: "同一被担保对象有效占用，按责任金额",
...
export const FP_MATTERS: PropertyMatter[] = [
  ...
  {
    id: "PTY-M011",
    name: "参股设计公司名称字号使用授权核查",
    matter_type: "标识名称",
    owner_org_id: "ORG-C",
    investor_id: "LE-C",
    investee_id: "LE-PART",
    related_project_id: "",
    template_id: "PR-IDENTITY-TEMPLATE-R3",
    current_phase_id: "PR-IDENTITY-R3-01",
    snapshot_ids: ["OWN-PART"],
    risk_ids: ["R-FP-025"],
    note: "合作终止后字号使用与授权期限核对",
    data_nature: "simulated",
  },
  {
    id: "PTY-M012",
    name: "单位A所属企业名称字号授权（正常）",
    matter_type: "标识名称",
    owner_org_id: "ORG-A",
    investor_id: "LE-A",
    investee_id: "LE-A",
...
export const FP_EVIDENCE: Evidence[] = [
  ...
  { id: "EVID-FP-040", title: "ACC-B 开户审批检索", data_nature: "simulated", source_type: "账户档案", recorded_at: "2025-06-08", body: "银行确认账户与企业台账齐全。开户日2025-06-08，检索开户日前无有效批准记录。不能仅因台账审批号为空判定。" },
  { id: "EVID-FP-012", title: "被投企业A担保额度占用", data_nature: "simulated", source_type: "担保台账", recorded_at: "2026-06-30", body: "被担保对象JV001有效占用3000万元，批准额度2000万元。样例合成，不宣称真实违规担保。" },
  { id: "EVID-FP-029", title: "出借LEND-01到期回收", data_nature: "simulated", source_type: "出借合同", recorded_at: "2026-06-30", body: "本金600万元，到期2026-05-31，有效回收0万元。借款方JV001。" },
  { id: "EVID-FP-025", title: "字号授权与退出事件", data_nature: "simulated", source_type: "授权文件", recorded_at: "2026-04-20", body: "授权有效至2026-03-31，合作终止2026-04-15后仍使用“海工设计”字号。" },
];
...
export const FP_RISKS: RiskCase[] = [
  ...
  risk({
    id: "R-FP-040",
    title: "企业账户开立缺少适用审批（ACC-B）",
    primary_domain: "CASH",
    domains: ["CASH"],
    primary_object_id: "ACC-B",
    owner_org_id: "ORG-B",
    severity: "yellow",
    status: "pending_review",
    current_task_due_date: "2026-07-22",
    ...
    last_seen_at: "2026-06-30",
    rule_id: "CASH2-R040",
    scenario_ids: ["CASH2-S040"],
    evidence_ids: ["EVID-FP-040"],
    data_nature: "simulated",
    responsible_role: "资金监管人员",
    assignee_display_name: null,
    current_task_type: "investigation",
  ...
  risk({
    ...
    primary_domain: "CASH",
    domains: ["CASH", "RIGHTS"],
    primary_object_id: "GUAR-01",
    owner_org_id: "ORG-A",
    severity: "red",
    status: "pending_review",
    current_task_due_date: "2026-07-16",
    first_seen_at: "2026-06-30",
    last_seen_at: "2026-06-30",
    rule_id: "CASH2-R012",
    scenario_ids: ["CASH2-S012"],
    evidence_ids: ["EVID-FP-012"],
    data_nature: "simulated",
    responsible_role: "资金监管人员",
    assignee_display_name: null,
    current_task_type: "investigation",
  ...
  risk({
    ...
    last_seen_at: "2026-06-30",
    rule_id: "CASH2-R029",
    scenario_ids: ["CASH2-S029"],
    evidence_ids: ["EVID-FP-029"],
    data_nature: "simulated",
    responsible_role: "资金监管人员",
    assignee_display_name: null,
    current_task_type: "investigation",
  ...
  risk({
    ...
    primary_domain: "RIGHTS",
    domains: ["RIGHTS"],
    primary_object_id: "PTY-M011",
    owner_org_id: "ORG-C",
    severity: "yellow",
    status: "pending_review",
    current_task_due_date: "2026-07-26",
    first_seen_at: "2026-04-20",
    last_seen_at: "2026-06-30",
    rule_id: "PTY2-R025",
    scenario_ids: ["PTY2-S025"],
    evidence_ids: ["EVID-FP-025"],
    data_nature: "simulated",
    responsible_role: "产权监管人员",
    assignee_display_name: null,
    current_task_type: "investigation",
...
export const FP_LINKS: RiskContextLink[] = [
  ...
  { risk_id: "R-FP-040", domain: "CASH", primary_phase_id: null, topic_id: "CASH2-T-ACCOUNT", phase_ids: [] },
  { risk_id: "R-FP-012", domain: "CASH", primary_phase_id: null, topic_id: "CASH2-T-FINANCE", phase_ids: [] },
  { risk_id: "R-FP-029", domain: "CASH", primary_phase_id: null, topic_id: "CASH2-T-OPERATION", phase_ids: [] },
  { risk_id: "R-FP-025", domain: "RIGHTS", primary_phase_id: null, topic_id: "PTY2-T-IDENTITY", phase_ids: [] },
];
...
export const FP_BUSINESS_LINKS: BusinessLink[] = [
  ...
  { id: "BL-LEND-RET", from_id: "LEND-01", to_id: "LEND-01", relation_type: "recovery_of", domains: ["CASH"], as_of: "2026-06-30", data_nature: "simulated" },
  { id: "BL-GUAR-OK", from_id: "GUAR-OK", to_id: "LE-PART", relation_type: "guarantee_of", domains: ["CASH", "RIGHTS"], as_of: "2026-06-30", data_nature: "simulated" },
...
export const FP_COVERAGE: MonitoringRow[] = [
  ...
  mon({
    id: "FP-MON-S040-HIT",
    scenario_id: "CASH2-S040",
    domain: "CASH",
    topic_id: "CASH2-T-ACCOUNT",
    monitoring_object_id: "ACC-B",
    object_type: "account",
    subject_object_id: "ACC-B",
    owner_org_id: "ORG-B",
    status: "evaluated_hit",
    rule_evaluation_ids: ["FP-EVAL-S040-HIT"],
    risk_ids: ["R-FP-040"],
    rule_ids: ["CASH2-R040"],
  }),
  mon({
    ...
    domain: "CASH",
    topic_id: "CASH2-T-ACCOUNT",
    monitoring_object_id: "ACC-A",
    object_type: "account",
    subject_object_id: "ACC-A",
    owner_org_id: "ORG-A",
    status: "evaluated_clear",
    rule_evaluation_ids: ["FP-EVAL-S040-OK"],
    risk_ids: [],
    rule_ids: ["CASH2-R040"],
  }),
  mon({
    ...
    domain: "CASH",
    topic_id: "CASH2-T-ACCOUNT",
    monitoring_object_id: "ACC-USD",
    object_type: "account",
    subject_object_id: "ACC-USD",
    owner_org_id: "ORG-OV",
    status: "data_insufficient",
    rule_evaluation_ids: [],
    risk_ids: [],
    rule_ids: ["CASH2-R040"],
    missing_data: ["开户日有效制度", "完整审批检索结果"],
  }),
  mon({
    id: "FP-MON-S012-HIT",
    scenario_id: "CASH2-S012",
    domain: "CASH",
    topic_id: "CASH2-T-FINANCE",
    monitoring_object_id: "GUAR-01",
    object_type: "contract",
    subject_object_id: "GUAR-01",
    owner_org_id: "ORG-A",
    status: "evaluated_hit",
    rule_evaluation_ids: ["FP-EVAL-S012-HIT"],
    risk_ids: ["R-FP-012"],
    rule_ids: ["CASH2-R012"],
  }),
  mon({
    ...
    domain: "CASH",
    topic_id: "CASH2-T-FINANCE",
    monitoring_object_id: "GUAR-OK",
    object_type: "contract",
    subject_object_id: "GUAR-OK",
    owner_org_id: "ORG-C",
    status: "evaluated_clear",
    rule_evaluation_ids: ["FP-EVAL-S012-OK"],
    risk_ids: [],
    rule_ids: ["CASH2-R012"],
  }),
  mon({
    id: "FP-MON-S029-HIT",
    scenario_id: "CASH2-S029",
    domain: "CASH",
    topic_id: "CASH2-T-OPERATION",
    monitoring_object_id: "LEND-01",
    object_type: "contract",
    subject_object_id: "LEND-01",
    owner_org_id: "ORG-A",
    status: "evaluated_hit",
    rule_evaluation_ids: ["FP-EVAL-S029-HIT"],
    risk_ids: ["R-FP-029"],
    rule_ids: ["CASH2-R029"],
  }),
  mon({
    ...
    domain: "CASH",
    topic_id: "CASH2-T-OPERATION",
    monitoring_object_id: "LEND-OK",
    object_type: "contract",
    subject_object_id: "LEND-OK",
    owner_org_id: "ORG-C",
    status: "evaluated_clear",
    rule_evaluation_ids: ["FP-EVAL-S029-OK"],
    risk_ids: [],
    rule_ids: ["CASH2-R029"],
  }),
  mon({
    id: "FP-MON-S025-HIT",
    scenario_id: "PTY2-S025",
    domain: "RIGHTS",
    topic_id: "PTY2-T-IDENTITY",
    monitoring_object_id: "PTY-M011",
    object_type: "property_matter",
    subject_object_id: "PTY-M011",
    owner_org_id: "ORG-C",
    status: "evaluated_hit",
    rule_evaluation_ids: ["FP-EVAL-S025-HIT"],
    risk_ids: ["R-FP-025"],
    rule_ids: ["PTY2-R025"],
  }),
  mon({
    ...
    owner_org_id: "ORG-A",
    status: "evaluated_clear",
    rule_evaluation_ids: ["FP-EVAL-S025-OK"],
    risk_ids: [],
    rule_ids: ["PTY2-R025"],
  }),
];
...
export const FP_EVALS: RuleEvaluation[] = [
  ...
  evalRow({
    ...
    subject_object_id: "ACC-B",
    result: "hit",
    rule_version: "FP-R3-1",
    inputs: { opened_on: "2025-06-08", approval_on: null },
    formula: "需事前审批且资料完整，开户日前无有效批准",
    risk_ids: ["R-FP-040"],
    evidence_ids: ["EVID-FP-040"],
    effective_result: "hit",
  }),
  evalRow({
    ...
    result: "clear",
    rule_version: "FP-R3-1",
    inputs: { opened_on: "2024-03-12", approval_on: "2024-03-01" },
    formula: "批准早于开户",
    risk_ids: [],
    evidence_ids: [],
    effective_result: "clear",
  ...
  evalRow({
    ...
    result: "hit",
    rule_version: "FP-R3-1",
    inputs: { occupancy: 3000, limit: 2000 },
    formula: "有效占用3000 > 批准额度2000",
    risk_ids: ["R-FP-012"],
    evidence_ids: ["EVID-FP-012"],
    effective_result: "hit",
  }),
  evalRow({
    ...
    result: "clear",
    rule_version: "FP-R3-1",
    inputs: { occupancy: 800, limit: 2000 },
    formula: "有效占用800 ≤ 批准额度2000",
    risk_ids: [],
    evidence_ids: [],
    effective_result: "clear",
  }),
  evalRow({
    ...
    result: "hit",
    rule_version: "FP-R3-1",
    inputs: { due: "2026-05-31", outstanding: 600, recovered: 0 },
    formula: "到期未收回本金600万元",
    risk_ids: ["R-FP-029"],
    evidence_ids: ["EVID-FP-029"],
    effective_result: "hit",
  }),
  evalRow({
    ...
    result: "clear",
    rule_version: "FP-R3-1",
    inputs: { due: "2026-04-30", recovered: 300 },
    formula: "到期义务已收回",
    risk_ids: [],
    evidence_ids: [],
    effective_result: "clear",
  ...
  evalRow({
    ...
    result: "hit",
    rule_version: "FP-R3-1",
    inputs: { auth_until: "2026-03-31", exit_on: "2026-04-15" },
    formula: "退出后仍使用授权字号",
    risk_ids: ["R-FP-025"],
    evidence_ids: ["EVID-FP-025"],
    effective_result: "hit",
