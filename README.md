...
| `docs/FP-20260916-R3/README.md` | **本轮有效**资金/产权增量（趋势、同分类穿透、专题覆盖、产权先专题） |
...
- 固定资产等流程领域用横向肩形箭头联动下区五数；资金管理为上区主体经营财务（盈利/资产负债/流动性，适用卡带小趋势、首页无完整单位表）+ 下区六专题；产权管理为上区法人股权全景（四项统计可带快照趋势）+ 下区先四专题，仅产权交易显示经济行为与流程；国际化用事件/地区。
